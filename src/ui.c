 ...
 *
 * Two CSS providers are loaded:
 *   css_common  — fonts, sizes, padding, accent colors that work on both
 *                 light and dark backgrounds. Always loaded.
 *   css_dark    — dark surface/background/border/text overrides. Only
 *                 loaded when conf.dark_theme is enabled. In light mode
 *                 the GTK system theme handles backgrounds and text
 *                 colors so the UI stays readable.
 *
 * Palette (dark):
 *   #0c1220  base background
 *   #141a2c  surface
 *   #1d2540  surface elevated
 *   #2c3756  border
 *   #3c4870  border strong
 *   #f5f5f7  text primary
 *   #8a96b8  text secondary
 *   #5a6280  text tertiary
 *
 * Accents (both modes):
 *   #0a84ff  Apple system blue
 *   #30d158  success / stereo
 *   #ff9f0a  warning
 *   #ff453a  danger
 */
...
"}\n"
"\n"
"/* Active / wait button states (vivid, work on both themes) */\n"
...
"}\n"
"\n"
"progressbar.xdr-cci trough,\n"
"progressbar.xdr-cci-dark trough,\n"
"progressbar.xdr-aci trough,\n"
"progressbar.xdr-aci-dark trough,\n"
"progressbar.xdr-signal trough,\n"
"progressbar.xdr-signal-dark trough {\n"
"    min-height: 20px;\n"
"}\n"
"\n"
...
"progressbar.xdr-signal-dark progress {\n"
"    background-image: none;\n"
...
/*
 * Light theme — light blue tinted, mirrors the structure of css_dark.
 *
 * Palette:
 *   #eef2fa  base background (very light blue-white)
 *   #ffffff  surface (entries, panels)
 *   #f4f7fd  elevated (button bg)
 *   #e4ebf7  hover
 *   #d6e2f5  active
 *   #cdd8ec  border
 *   #a8b6d0  border strong
 *   #0f1a2e  text primary (dark navy)
 *   #4a5575  text secondary
 *   #6b7795  text tertiary
 *   #0a84ff  accent (system blue)
 */
...
"}\n"
"\n"
".xdr-freq, .xdr-header, .xdr-status, .xdr-rt {\n"
"    color: #0f1a2e;\n"
"}\n"
"\n"
".xdr-title {\n"
...
"entry:focus {\n"
"    border-color: #0a84ff;\n"
"    box-shadow: 0 0 0 2px rgba(10, 132, 255, 0.20);\n"
"}\n"
"\n"
"spinbutton {\n"
"    background-image: none;\n"
...
"    min-width: 14px;\n"
"    min-height: 14px;\n"
"    box-shadow: 0 1px 3px rgba(15, 26, 46, 0.15);\n"
"    margin: -6px;\n"
"}\n"
"\n"
"notebook {\n"
...
ui_init()
{
    ...
    GtkCssProvider *provider_common = gtk_css_provider_new();
    gtk_css_provider_load_from_data(provider_common, css_common, -1, NULL);
    gtk_style_context_add_provider_for_screen(screen, GTK_STYLE_PROVIDER(provider_common), GTK_STYLE_PROVIDER_PRIORITY_USER);

    {
        GtkCssProvider *provider_theme = gtk_css_provider_new();
        gtk_css_provider_load_from_data(provider_theme,
                                        conf.dark_theme ? css_dark : css_light,
                                        -1, NULL);
        gtk_style_context_add_provider_for_screen(screen, GTK_STYLE_PROVIDER(provider_theme), GTK_STYLE_PROVIDER_PRIORITY_USER + 1);
    }
    ...
    gtk_style_context_add_class(gtk_widget_get_style_context(ui.l_freq), "xdr-freq");
